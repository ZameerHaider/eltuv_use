...
class _CartScreenState extends State<CartScreen> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      print("Printing" + collectionProduct.length.toString());
    });
  }
  ...
  _callAPIPOstOrder(BuildContext context) {
    ...
    collectionProduct.forEach((CollectionProduct element) {
      List<Optional> opt = [];
  ...
  Widget build(BuildContext context) {
    ...
    return CustomLoader(
      ...
      child: Scaffold(
        ...
        body: collectionProduct.isEmpty
            ? Center(
                child: Text(
                  ...
                  child: Column(
                    ...
                    children: [
                      ListView.builder(
                        ...
                        shrinkWrap: true,
                        itemCount: collectionProduct.isEmpty
                            ? 0
                            : collectionProduct.length,
                        itemBuilder: (context, index) => CartItem(
                          prod: collectionProduct[index],
                        ),
                      ),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Consumer<HomeProvider>(
                                ...
                                return Text(
                                  cart.updateItemTotalPrice().toString(),
                                  style: TextStyle(
                                    fontSize: size.width * 0.034,
                                    fontWeight: FontWeight.bold,
                                    color: colorBlack,
